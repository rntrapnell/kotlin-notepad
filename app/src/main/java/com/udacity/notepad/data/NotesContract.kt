...
object NotesContract {
    const val SQL_CREATE_ENTRIES = "CREATE TABLE ${NoteTable._TABLE_NAME}(${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ${NoteTable.TEXT} TEXT, ${NoteTable.IS_PINNED} INTEGER, ${NoteTable.CREATED_AT} INTEGER, ${NoteTable.UPDATED_AT} INTEGER)"
